...
columns=[i for i in DF_con.columns if (i.count('Descripción')==0 and i.count('Palabras')==0)]
...
document=st.number_input('Documento de interesado: ', min_value=1000000, max_value=10000000000,value=None)
